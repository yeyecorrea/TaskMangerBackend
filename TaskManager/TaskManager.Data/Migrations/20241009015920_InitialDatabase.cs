        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionNew = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_historyChanges_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_historyChanges_taskeds_TaskedId",
                        column: x => x.TaskedId,
                        principalTable: "taskeds",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_taskedTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_taskedTags_tags_TagId",
                        column: x => x.TagId,
                        principalTable: "tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_taskedTags_taskeds_TaskedId",
                        column: x => x.TaskedId,
                        principalTable: "taskeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_historyChanges_TaskedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_taskedTags_TagId",
                table: "taskedTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_taskedTags_TaskedId",
                table: "taskedTags",
                column: "TaskedId");
        }
